...
training_dataset = load_dataset("csv", data_files="training_data.4000.csv", split="train")
print(training_dataset)
evaluation_dataset = load_dataset("csv", data_files="evaluation_data.2000.csv", split="train")
print(evaluation_dataset)

base_model = "microsoft/phi-2"
new_model = "phi2-text-2-sql"
