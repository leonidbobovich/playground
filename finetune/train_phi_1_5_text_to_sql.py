...
training_dataset = load_dataset("csv", data_files="training_data.csv", split="train")
print(training_dataset)
evaluation_dataset = load_dataset("csv", data_files="evaluation_data.csv", split="train")
print(evaluation_dataset)

base_model = "microsoft/phi-1_5"
new_model = "phi-1_5-text-2-sql"
